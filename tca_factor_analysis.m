function tca_factor_analysis(base_output_path)
    ...
    for i = 1:length(conditions)
        ...
        mat_files = dir(fullfile(condition_path, '*pc_cumulative_variance.mat'));
        ...
        for j = 1:length(mat_files)
            ...
            if isfield(data, 'pc_cumulative_variance')
                pc_cumulative_explained = data.pc_cumulative_variance;
            else
            ...
            subject_name = erase(subject_name, 'pc_cumulative_variance'); % Remove suffix
